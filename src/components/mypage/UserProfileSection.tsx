      ...
      <ButtonsContainer>
        ...
        <IconButton onClick={() => navigate('/mypage/settings')}>
          <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
            <path d="M12.0007 14.2427C13.2435 14.2427 14.2427 13.2435 14.2427 12.0007C14.2427 10.7578 13.2435 9.75867 12.0007 9.75867C10.7578 9.75867 9.75867 10.7578 9.75867 12.0007C9.75867 13.2435 10.7578 14.2427 12.0007 14.2427Z" />
